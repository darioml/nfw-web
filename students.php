...
<style>
body{
background-image:url('images/NFW_website_background_final_version.jpg');
...
<BR><BR>
            <br/>
<div style="background-image: url(images/NFW_website_register_final_version.png); height: 1500px; width: 1000px; margin-left: auto; margin-right: auto;" >
<BR><BR><BR><BR><BR><BR><BR><BR><BR>
<h1>Student Applications</h1>

        <form id="formID" class="formular" method="post" action="" style="width:900px" enctpye="multipart/form-data">
            <fieldset>
                <legend>
                    Contact Details
                </legend>
...
<td width=50%>
 ...
 <label>
               <span>Please choose a password</span>
                       <input value="" type="password" name="password" class=text-input id="password" />
                                                                           </label>
                    </table>                                                       
            </fieldset>
...
<option value="20-21">20 to 21</option>
<option value="22-23">22 to 23</option>
<option value="Over23">Over 23</option>
</select>
...
<option>Yale University</option>                     
   ...
   <label>
                                     <span>Educational Aspirations</span>
...
<option>Other</option>    
 ...
 <label>
       ...
       <input value="" class="validate[required,custom[onlyLetterNumber],maxSize[40]] text-input" type="text" name="futurecareer" id="futurecareer" />
...
<select multiplie=multiple name="workexperience[]">
<option>Accountancy and business services</option>
<option>Adverstising, marketing and PR</option>
<option>Armed forces and emergency services</option>
<option>Banking and finance</option>
<option>Chairty and development work</option>
...
<option>Other, please specify (text)</option>
...
I understand that my information will be stored in the ICFC database. I state that all details above are correct and will produce proof of student status if required
</label>
...
By submitting this application I understand that my information will be stored in the ICFC database. I state that all details above are correct and will produce proof of student status if required.

<label>
<span>What do you hope to gain from attending the conference?</span>
<textarea name="gain" id="gain">
</textarea>
</label>


<label>
<span>Please briefly describe your career objectives</span>
<textarea name="careerobjectives" id="careerobjecives">
</textarea>
</label>
